  ...
  test("POST /emails", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        scrapedDate: CREATE_RESULT.scrapedDate.toISOString(),
      ...
      .expect([
        {
          ...
          scrapedDate: FIND_MANY_RESULT[0].scrapedDate.toISOString(),
  ...
  test("GET /emails/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        scrapedDate: FIND_ONE_RESULT.scrapedDate.toISOString(),
